      ...
      if (interruption.raison === 'sous-evalue') {
        sugBox.innerHTML = `
          ...
          <div class="suggestion-text" style="margin-bottom:.6rem">
            Votre maxi est probablement <strong>sous-évalué</strong>. Recalculez-le, puis revenez reprendre votre atelier depuis le début avec le bon maxi.<br><em>Vous allez être redirigé(e) automatiquement.</em>
          </div>
        ...
        sugBox.innerHTML = `
          ...
          <div class="suggestion-text" style="margin-bottom:.6rem">
            Votre maxi est probablement <strong>surévalué</strong>. Recalculez-le, puis revenez reprendre votre atelier depuis le début avec le bon maxi.<br><em>Vous allez être redirigé(e) automatiquement.</em>
          </div>
          <div class="suggestion-actions">
